export default function StatusPage({
  ...
  return (
    <div className="min-h-screen bg-[#991b1b] flex flex-col items-center justify-center text-white text-center px-6">
      ...
      <button onClick={onButtonClick} className="btn btn-lg mt-10 font-bold rounded-xl hover:opacity-90 transition-all bg-white text-[#991b1b] hover:bg-[#ffd700] hover:text-[#991b1b] hover:border-[#ffd700]">
        {buttonLabel}
      </button>
    </div>
  );
