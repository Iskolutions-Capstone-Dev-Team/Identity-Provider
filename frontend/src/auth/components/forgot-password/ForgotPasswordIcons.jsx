...
export function EyeIcon({ isVisible }) {
  if (isVisible) {
    return (
...
export function CheckIcon({ className = "h-10 w-10" }) {
  return (
...
export function CloseButton({ onClose }) {
  return (
    <button type="button" className="btn btn-circle btn-sm shrink-0 border border-white/12 bg-white/10 text-white shadow-none backdrop-blur-sm transition hover:border-[#ffd700]/45 hover:bg-white/20 hover:text-[#ffd700]" onClick={onClose} aria-label="Close forgot password modal">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
