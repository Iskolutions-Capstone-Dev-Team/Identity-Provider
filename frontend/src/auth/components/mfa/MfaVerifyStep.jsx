  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3 rounded-2xl border border-white/14 bg-white/8 p-4">
        <button type="button" onClick={onSelectAuthenticator} disabled={isCheckingAuthenticators} className="flex w-full items-center justify-between rounded-xl border border-[#ffd700]/70 bg-[#ffd700]/15 px-4 py-3 text-left text-white transition hover:border-[#ffd700] hover:bg-[#ffd700]/20 disabled:cursor-wait disabled:opacity-70">
          <span>
