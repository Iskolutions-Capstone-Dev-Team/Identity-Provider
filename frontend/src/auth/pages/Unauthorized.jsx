  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#250508] font-[Poppins] text-white">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center gap-4 px-6 text-center">
        ...
        <button onClick={() => navigate("/logout", { replace: true })} className="btn btn-lg mt-6 rounded-xl border-[#ffd700] bg-[#ffd700] font-bold text-[#991b1b] transition-all hover:border-[#ffd700] hover:bg-white hover:text-[#991b1b]">
          Return to Login
        </button>
      </div>
    </div>
