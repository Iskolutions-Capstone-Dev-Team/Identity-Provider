...
// SuccessIcon — used in SuccessAlert
...
// CloseIcon — used in ErrorAlert and SuccessAlert
...
// TrashIcon — used in DeleteConfirmModal
export function TrashIcon({ className = "h-10 w-10" }) {
  return (
...
// EmptySearchIcon — used in EmptySearchState
...
// ChevronDownIcon — used in MultiSelect dropdown trigger
...
// SunIcon — used in Navbar (color mode toggle, light state)
...
// MoonIcon — used in Navbar (color mode toggle, dark state)
...
// ProfileIcon — used in Navbar (profile button)
export function ProfileIcon({ className = "h-8 w-8" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
...
// FacebookIcon — used in Footer
export function FacebookIcon({ className = "w-6 h-6 mx-auto" }) {
  return (
...
// YouTubeIcon — used in Footer
export function YouTubeIcon({ className = "w-6 h-6 mx-auto" }) {
  return (
...
// ToggleIcon — used in AssistiveFab (open/close toggle button)
export function ToggleIcon({ isOpen }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
      className={`h-7 w-7 transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] ${isOpen ? "rotate-45" : "rotate-0"}`}
    >
...
// AccessibilityIcon — used in AssistiveFab (accessibility button)
...
// FaqIcon — used in AssistiveFab (FAQ button)
...
// MicrophoneIcon — used in SpeechInputButton (idle state)
...
// StopIcon — used in SpeechInputButton (listening state)
...
// ShieldCheckIcon — used in TermAgreementModal (consent section icon)
...
// LockOpenIcon — used in TermAgreementModal (privacy section icon)
