...
export default function SuccessAlert({ message, onClose }) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-4 top-24 z-[180] flex justify-center sm:top-28 md:inset-x-auto md:right-4 md:top-32 md:w-[24rem] md:justify-start lg:bottom-5 lg:left-[var(--idp-success-alert-left)] lg:right-auto lg:top-auto lg:w-auto">
