        ...
        <table className="table w-full min-w-[72rem] lg:min-w-0 lg:table-fixed">
          ...
          <tbody>
            ...
            {logs.map((log, index) => (
              ...
              >
                <td className={`${bodyCellClassName} font-mono text-[0.82rem] text-[#7b0d15]`}>
                  {log.timestamp}
                </td>
                <td
                  className={`${bodyCellClassName} max-w-56 whitespace-nowrap font-semibold text-[#4a1921]`}
                  title={log.actor}
                >
                ...
                <td className={bodyCellClassName}>
                  <span
                    className={`inline-flex min-w-[6rem] items-center justify-center rounded-full px-3 py-1.5 text-xs font-semibold tracking-[0.06em] ${getStatusClasses(log.status)}`}
                  >
                    {log.status}
                  </span>
                </td>
