...
import { CheckIcon, ClockIcon, FingerprintIcon, ShieldIcon } from "./DashboardIcons";
...
export default function SecurityAnalysisPanel({ analysis, analyzedAt, colorMode = "light" }) {
  ...
  return (
    <DashboardPanel colorMode={colorMode} className="p-5">
      ...
      <div className={`mt-7 rounded-xl border border-[#f8c21a]/30 p-4 ${
        isDarkMode ? "bg-[#2c2108]/42" : "bg-[#fff8d8]"
      }`}>
        <p className="font-black text-[#f8c21a]">
          What does this mean?
        </p>
        <p className="mt-2 text-sm leading-6 text-[#f8d24e]">
