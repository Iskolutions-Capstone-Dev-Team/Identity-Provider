                            ...
                            <TableRowFade key={u.id}>
                                ...
                                <td className="gap-2 text-center border-gray-200">
                                    <div className="flex gap-2 justify-center">
                                        ...
                                        {showDeleteAction && (
                                            <button className="btn btn-ghost p-2 border-none rounded-xl text-[#991b1b] hover:bg-[#ffd700]/30 hover:scale-110 hover:shadow-xl transition-all" onClick={() => onDelete(u)}>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
