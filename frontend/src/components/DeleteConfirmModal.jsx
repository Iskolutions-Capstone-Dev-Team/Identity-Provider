    ...
    <dialog className={`modal modal-middle ${open ? "modal-open" : ""}`}>
      <form method="dialog" className="modal-box bg-white rounded-2xl text-center">
        ...
        <div className="modal-action justify-center">
          <button type="button" className="btn btn-outline h-12 rounded-lg text-[#991b1b] border-[#991b1b] hover:bg-[#ffd700] hover:border-[#ffd700] hover:text-[#991b1b]" onClick={onCancel}>Cancel</button>
          <button type="button" className="btn bg-[#991b1b] h-12 rounded-lg text-white border-[#991b1b] hover:bg-[#ffd700] hover:border-[#ffd700] hover:text-[#991b1b]" onClick={onConfirm}>Delete</button>
        </div>
      </form>
    </dialog>
  );
