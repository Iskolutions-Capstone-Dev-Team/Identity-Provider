...
const FAB_CONTAINER_CLASS_NAME =
  "pointer-events-none fixed bottom-[1.65rem] left-1/2 -translate-x-1/2 z-[100] flex h-16 w-16 items-center justify-center lg:bottom-20 lg:left-auto lg:right-6 lg:-translate-x-0";
