export function RegistrationIcon({ className = "size-6" }) {
  return (
...
export function CreateRegistrationIcon({ className = "size-6" }) {
  return (
...
export function SyncConfirmIcon({ className = "h-10 w-10 text-white" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
