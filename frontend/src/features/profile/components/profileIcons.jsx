export function SuccessIcon({ className = "h-10 w-10" }) {
  return (
...
export function EmailIcon({ className = "h-4 w-4 shrink-0" }) {
  return (
...
export function EnvelopeIcon({ className = "h-8 w-8" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function PhoneIcon({ className = "h-7 w-7 sm:h-8 sm:w-8" }) {
  return (
...
export function PasskeyIcon({ className = "h-7 w-7 sm:h-8 sm:w-8" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export function ConnectionSetupIcon({ className = "h-10 w-10 text-[#ffe28a]" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export function PasswordLockIcon({ className }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
