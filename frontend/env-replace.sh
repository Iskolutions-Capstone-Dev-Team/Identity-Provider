...
VARS="VITE_API_BASE_URL VITE_CLIENT_ID VITE_REDIRECT_URI VITE_CLIENT_SECRET"
VARS="$VARS VITE_BACKEND_URL VITE_ONE_PORTAL_CLIENT_ID VITE_ONE_PORTAL_URL VITE_API_DOCS_URL"
VARS="$VARS BACKEND_PROXY_TARGET"
