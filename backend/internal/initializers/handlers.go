...
func InitializeHandlers(db *sqlx.DB,
	...
	return &api.Handlers{
		...
		MFAHandler:     v1.NewMFAHandler(service.MFAService, service.UserService),
		PasskeyHandler: v1.NewPasskeyHandler(service.PasskeyService),
		MetricsHandler: v1.NewMetricsHandler(service.MetricsService),
		UserRepo:       userRepo,
		RoleRepo:       roleRepo,
		PubKey:         PubKey,
